  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        {(filterProperty || filterRoomType) && (
          <button
            onClick={() => { setFilterProperty(''); setFilterRoomType(''); }}
                ...
                <tr key={r.id} className="hover:bg-stone-50/50 transition-colors">
                  <td className="table-cell">
                    {r.images && r.images.length > 0 ? (
                      ...
                      <div className="w-12 h-12 rounded-lg bg-stone-100 flex items-center justify-center text-stone-400 text-lg">
                        🚪
                      </div>
                    )}
                  </td>
                  ...
                  <td className="table-cell">
                    <span className="text-xs text-orange-600 font-medium">{getCommissionText(r)}</span>
                  </td>
                  <td className="table-cell">
